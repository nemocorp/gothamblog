...
BLOG_AUTHOR = "Nemocorp"
BLOG_TITLE = "Gotham Blog"
# This is the main URL for your site. It will be used
# in a prominent link
SITE_URL = "http://gothamblog.nemocorp.info/"
# This is the URL where nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://getnikola.com/"
BLOG_EMAIL = "wouham@nemocorp.info"
BLOG_DESCRIPTION = "Le blog d'infos culturelles qui a 10 ans de retard... voire plus"
...
DEPLOY_COMMANDS = [
    'rsync -rav --delete output/* u39468970@id.nemocorp.info:./',
]
...
#DATE_FORMAT = '%A %d %B %Y &agrave; %H:%M'
DATE_FORMAT = '%A %d %B %Y'
...
READ_MORE_LINK = '<p class="more pull-right"><a href="{link}">{read_more}…</a></p>'
...
# Default is ''
CONTENT_FOOTER = '{license}&nbsp;Contenus &copy; {date}         <a href="mailto:{email}">{author}</a> - Propulsé par <a href="http://getnikola.com">Nikola</a>'
...
# is in the manual.
COMMENT_SYSTEM_ID = "nemocorp-gothamblog"
